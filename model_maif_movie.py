...
class MAIF(object):
    ...
    def __init__(self, input_format):
        ...
        self.seq_his_item_attn = self.get_sequence_embedding_with_transformer('his_short_seq', self.hisids,
                                                                              T=self.params[
                                                                                  'his_short_seq_max_len'],
                                                                              target_embedding=self.target_item_in,
                                                                              mode='attention',
                                                                              seq_embedding=self.seq_his_item_in,
                                                                              user_embedding=None)
        ...
        self.seq_his_join_cate1_attn = self.get_sequence_embedding_with_transformer_feature('his_feature_short_seq', self.hisids, T=self.params['his_short_seq_max_len'], target_embedding=self.target_cate1_in, mode='attention', seq_embedding=[self.seq_his_cate2_in, self.seq_his_year_in, self.seq_his_stars_in], target_seq_embedding=self.seq_his_cate1_in, user_embedding=self.user_emb_join)
        self.seq_his_join_cate2_attn = self.get_sequence_embedding_with_transformer_feature('his_feature_short_seq', self.hisids, T=self.params['his_short_seq_max_len'], target_embedding=self.target_cate2_in, mode='attention', seq_embedding=[self.seq_his_cate1_in, self.seq_his_year_in, self.seq_his_stars_in], target_seq_embedding=self.seq_his_cate2_in, user_embedding=self.user_emb_join)
        self.seq_his_join_year_attn = self.get_sequence_embedding_with_transformer_feature('his_feature_short_seq', self.hisids, T=self.params['his_short_seq_max_len'], target_embedding=self.target_year_in, mode='attention', seq_embedding=[self.seq_his_cate1_in, self.seq_his_cate2_in,  self.seq_his_stars_in], target_seq_embedding=self.seq_his_year_in, user_embedding=self.user_emb_join)
        self.seq_his_join_stars_attn = self.get_sequence_embedding_with_transformer_feature('his_feature_short_seq', self.hisids, T=self.params['his_short_seq_max_len'], target_embedding=self.target_stars_in, mode='attention', seq_embedding=[self.seq_his_cate1_in, self.seq_his_cate2_in, self.seq_his_year_in], target_seq_embedding=self.seq_his_stars_in, user_embedding=self.user_emb_join)

        self.seq_side_attn_concat = tf.concat([tf.expand_dims(self.seq_his_join_cate1_attn, 1),tf.expand_dims(self.seq_his_join_cate2_attn, 1),tf.expand_dims(self.seq_his_join_year_attn, 1),tf.expand_dims(self.seq_his_join_stars_attn, 1)], 1)
        ...
        # predicting layer
        self.deep_out = tf.concat([self.user_emb_join, self.target_join_in, self.seq_his_item_attn, self.seq_his_join_all_attn_sum], 1)
